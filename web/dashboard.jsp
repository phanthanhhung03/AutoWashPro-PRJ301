        ...
        <div class="modal-overlay" id="addVehicleModalOverlay">
            <div class="modal-card" id="addVehicleModalCard" role="dialog" aria-modal="true"
                ...
                <div class="modal-card__body">
                    ...
                    <!-- TODO: Validate data from SQL Server -->
                    <form action="AddVehicle" method="post" id="addVehicleServletForm">

                        <div class="form-group">

                            <label for="brand" class="form-group__label">
                                Vehicle Brand
                            </label>
                        ...
                        <div class="form-group">
                            <label for="vehicleModel" class="form-group__label">
                                Vehicle Model Name
                            </label>
                        ...
                        <div class="form-group">
                            <label for="licensePlate" class="form-group__label">
                        ...
                        <div class="form-group">
                            <label for="color" class="form-group__label">
                                Vehicle Color
                            </label>
