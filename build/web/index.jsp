...
<html lang="en">
    ...
    <body data-login-error="${not empty requestScope.EMAIL_ERROR or not empty requestScope.PASSWORD_ERROR}">
                ...
                <div class="modal-card__body">
                    ...
                    <form action="LoginServlet" method="post" id="signInServletForm">
                        <div class="form-group">
                            ...
                            <div class="form-group__input-wrapper"> <i class="fa-solid fa-envelope form-group__icon"></i>
                                <input type="email" class="form-group__input" id="loginEmail" name="email" placeholder="name@example.com" autocomplete="email" required> </div>
                                <p class="form-error">${requestScope.EMAIL_ERROR}</p>
                        </div> <div class="form-group">
                            <label for="loginPassword" class="form-group__label"> Password </label>
                            <div class="form-group__input-wrapper"> <i class="fa-solid fa-lock form-group__icon"></i>
                                <input type="password" class="form-group__input" id="loginPassword" name="password" placeholder="Enter your password" autocomplete="current-password" required>
                            </div>
                            <p class="form-error">${requestScope.PASSWORD_ERROR}</p>
                        </div> <div class="form-actions-row">
                            <label class="form-checkbox" for="loginRemember">
                                <input type="checkbox" class="form-checkbox__input" id="loginRemember" name="remember" value="true"> Remember me </label>
                                <a href="#" class="form-link" id="forgotPasswordLink"> Forgot Password? </a>
                        </div>
                        <button type="submit" class="btn btn--primary" id="submitSignInBtn"> Sign In </button>
                    </form>
                </div>
<h1>${requestScope.EMAIL_ERROR}</h1>
                <div class="modal-card__footer">
